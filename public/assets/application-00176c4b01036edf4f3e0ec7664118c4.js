...
(function() {
  jQuery(function() {
    return $(document).ready(function() {
      return $('ul#page-nav a').click(function(e) {
        var target;
        e.preventDefault();
        target = this.hash;
  ...
  jQuery(function() {
    return $(document).ready(function() {
      ...
      if ($('form.edit_user').length > 0) {
        $('input#user_gravatar').bootstrapSwitch(function() {});
        $('ul#edit-tabs li').click(function(e) {
          var ckeditor, content, prevSectionContent, prevSectionName, sectionName;
          ...
          return ckeditor.setData(content);
        });
        $('input#edit-submit').click(function(e) {
          ...
          return $('form.edit_user').submit();
        });
        content = $('#user_welcome_section').val();
        return CKEDITOR.instances['edit-ta'].setData(content);
      }
    });
  });
